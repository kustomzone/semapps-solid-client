...
curl -X PUT -H "Content-Type: text/html" -T thesis.html http://localhost:5000/file/thesis.html
curl -s http://localhost:5000/file/thesis.html | wc -l
curl -s http://localhost:5000/file/thesis.html -H "Accept: text/turtle"
curl -s http://localhost:5000/file/thesis.html -H "Accept: application/n-triples" | wc -l
